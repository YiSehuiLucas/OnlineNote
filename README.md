...
- ✅ 浏览器访问，三栏布局：目录树 / 编辑器 / 实时预览
- ✅ Markdown 基础语法：标题、列表、引用、代码块、链接、图片、加粗、删除线等
- ✅ 文件目录树：新建 / 重命名 / 删除笔记与文件夹（右键菜单）
...
- **后端**：Go 1.22+ / Gin / SQLite（modernc 纯 Go 驱动）/ bcrypt / HMAC Cookie 会话
- **前端**：原生 HTML/CSS/JS 静态页面（零构建），内置轻量 Markdown 渲染器
